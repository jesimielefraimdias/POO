...
//Pode, também, ser inicializado sem elementos e sem repetições caso os valores default sejam utilizados.
//Desse modo, conseguimos retirar a necessidade de sobrecarregar o construtor para atender as requisições do mainVetor quando
//criado um objeto.
Vetor::Vetor(int elemento, int nRepeticoes){
		indice = nRepeticoes;
...
void Vetor::preencher(int elemento, int nRepeticoes){
		...
		for(indice = 0; indice < nRepeticoes; indice++) vetor[indice] = elemento;
